...
We present several sound and complete conditions for finite-trace equivalence between states of GKAT coalgebras in~\Cref{thm:norm-bisim-correctness}, which also serves as the core correctness theorem for our equivalence-checking algorithm i.e.~\Cref{alg:bisim}.
This algorithm mostly consists of recursively checking the conditions in~\Cref{thm:norm-bisim-correctness} with minor optimizations, which we will outline later.
